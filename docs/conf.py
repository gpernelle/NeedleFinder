# -*- coding: utf-8 -*-
#
# NeedleFinder documentation build configuration file, created by
# sphinx-quickstart on Tue Nov 25 12:12:01 2014.
#
...
# sys.path.insert(0, os.path.abspath('/Users/guillaume/Projects/github/NeedleFinderAmastm/NeedleFinder/NeedleFinder'))
sys.path.append(os.path.abspath('../NeedleFinder'))
...
htmlhelp_basename = 'NeedleFinderdoc'
